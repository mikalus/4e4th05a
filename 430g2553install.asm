...
; ;
    ...
    HEADER(INSTALL,7,"INSTALL",DOCOLON)
        DW  TICK,TOBODY
        DW  lit,VECAREA,PAD,lit,VECS_SIZE*2,CMOVE
        DW  SWAP,TWOSTAR,CELLS,PAD,PLUS
        DW  lit,4030h,OVER,STORE
        DW  CELLPLUS,STORE,D_INT
        DW  lit,VECAREA,lit,VECS_SIZE*2,FLERASE
        DW  PAD,lit,VECAREA,lit,VECS_SIZE*2,DTOI
        DW  E_INT,TICKSOURCE,FETCH,TOIN,STORE
        DW  EXIT
